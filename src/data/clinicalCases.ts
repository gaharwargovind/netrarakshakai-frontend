...
export const CLINICAL_CASE_PRESETS: ClinicalCasePreset[] = [
      ...
      quality: {
        ...
        metrics: {
          focus: {
            name: 'Focus / Acuity',
            value: 0.98,
            displayValue: 'Optimal Acuity',
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Pristine vessel edge definition and clear foveal reflex.',
          },
          field_of_view: {
            name: 'Field of View',
            value: 0.97,
            displayValue: '45° Centered',
            threshold: 0.75,
            status: 'acceptable',
            clinicalDescription: 'Standard two-field screening protocol satisfied.',
          },
          illumination: {
            name: 'Illumination',
            value: 0.96,
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Even light distribution across 4 quadrants.',
          },
          contrast: {
            name: 'Vessel Contrast',
            value: 0.95,
            displayValue: 'High',
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Well-separated color histogram.',
          },
          noise: {
            name: 'Signal-to-Noise',
            value: 0.97,
            displayValue: '28.1 dB',
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Negligible image sensor noise.',
          },
        },
      },
      classification: {
      ...
      quality: {
        ...
        metrics: {
          focus: {
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'High resolution optic disc margin and foveal light reflex intact.',
          },
          field_of_view: {
            name: 'Field of View',
            value: 0.96,
            ...
            threshold: 0.75,
            status: 'acceptable',
            clinicalDescription: 'Full macular-papillary arc visible.',
          },
          illumination: {
            name: 'Illumination',
            value: 0.94,
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Balanced flash exposure.',
          },
          contrast: {
            name: 'Vessel Contrast',
            value: 0.92,
            ...
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Clear capillary contrast against retinal pigment epithelium.',
          },
          noise: {
            name: 'Signal-to-Noise',
            value: 0.95,
            displayValue: '26.8 dB',
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Clean signal profile.',
          },
        },
      },
      classification: {
  ...
  },
  {
    ...
    mockResponse: {
      ...
      quality: {
        ...
        metrics: {
          focus: {
            name: 'Focus / Acuity',
            value: 0.96,
            displayValue: 'High Acuity',
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Sharp foveal avascular zone & tertiary vessel borders resolved.',
          },
          field_of_view: {
            name: 'Field of View',
            value: 0.95,
            ...
            threshold: 0.75,
            status: 'acceptable',
            clinicalDescription: 'Adequate optic disc and macular coverage meets screening standards.',
          },
          illumination: {
            name: 'Illumination',
            value: 0.92,
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'No central saturation or severe peripheral underexposure.',
          },
          contrast: {
            name: 'Vessel Contrast',
            value: 0.89,
            ...
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Vessel-to-parenchyma dynamic range allows reliable feature extraction.',
          },
          noise: {
            name: 'Signal-to-Noise',
            value: 0.91,
            displayValue: '25.4 dB',
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Low thermal detector artifact; minimal sensor grain.',
          },
        },
      },
      classification: {
      ...
      recommendation: {
        referable: true,
        category: 'Specialist referral recommended',
  ...
  },
  {
    ...
    description: 'Demonstration scenario of pre-proliferative changes. 4-2-1 rule: extensive multi-quadrant hemorrhages and venous beading. High risk of conversion to proliferative DR.',
    ...
    mockResponse: {
      ...
      quality: {
        ...
        metrics: {
          focus: {
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Venous beading borders and intraretinal microvascular abnormalities resolved.',
          },
          field_of_view: {
            name: 'Field of View',
            value: 0.95,
            ...
            threshold: 0.75,
            status: 'acceptable',
            clinicalDescription: 'Quadrants clearly demarcated.',
          },
          illumination: {
            name: 'Illumination',
            value: 0.90,
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Consistent illumination profile.',
          },
          contrast: {
            name: 'Vessel Contrast',
            value: 0.91,
            ...
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'High contrast between hemorrhages and background.',
          },
          noise: {
            name: 'Signal-to-Noise',
            value: 0.93,
            displayValue: '26.1 dB',
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Low artifact level.',
          },
        },
      },
      classification: {
      ...
      recommendation: {
        referable: true,
        category: 'Specialist referral recommended',
        reason: 'Severe Non-Proliferative Diabetic Retinopathy (ICDR Grade 3) identified with high risk of proliferative progression.',
        suggested_action: 'Specialist assessment recommended. Follow the applicable local referral pathway.',
        timeframe: 'Per applicable local clinical protocol and practitioner guidance.',
      },
      timing: {
  ...
  },
  {
    ...
    description: 'Demonstration scenario of advanced sight-threatening disease. Neovascular fronds and preretinal hemorrhage requiring urgent vitreoretinal surgical/laser consultation.',
    ...
    mockResponse: {
      ...
      quality: {
        ...
        metrics: {
          focus: {
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Sufficient clarity despite media haze from minor preretinal blood.',
          },
          field_of_view: {
            name: 'Field of View',
            value: 0.94,
            ...
            threshold: 0.75,
            status: 'acceptable',
            clinicalDescription: 'Full visualization of optic disc and temporal vascular branches.',
          },
          illumination: {
            name: 'Illumination',
            value: 0.88,
            ...
            threshold: 0.70,
            status: 'acceptable',
            clinicalDescription: 'Proper retinal exposure across macula.',
          },
          contrast: {
            name: 'Vessel Contrast',
            value: 0.85,
            ...
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Neovascular vessel branches discernible.',
          },
          noise: {
            name: 'Signal-to-Noise',
            value: 0.89,
            displayValue: '23.8 dB',
            threshold: 0.65,
            status: 'acceptable',
            clinicalDescription: 'Signal quality adequate for deep feature analysis.',
          },
        },
      },
      classification: {
      ...
      recommendation: {
        referable: true,
        category: 'Urgent specialist referral',
        reason: 'Proliferative Diabetic Retinopathy (ICDR Grade 4) identified with immediate risk of irreversible vision loss.',
        suggested_action: 'Specialist assessment recommended. Follow the applicable local referral pathway.',
        timeframe: 'Per applicable local clinical protocol and practitioner guidance.',
      },
      timing: {
      ...
      quality: {
        ...
        metrics: {
          focus: {
            name: 'Focus / Acuity',
            value: 0.32,
            displayValue: 'Severe Blur',
            threshold: 0.70,
            status: 'unacceptable',
            clinicalDescription: 'High spatial frequency loss; vessel margins blurred due to eye movement.',
          },
          field_of_view: {
            name: 'Field of View',
            value: 0.61,
            displayValue: 'Off-Center',
            threshold: 0.75,
            status: 'warning',
            clinicalDescription: 'Macular region clipped by camera border.',
          },
          illumination: {
            name: 'Illumination',
            value: 0.41,
            displayValue: 'Underexposed',
            threshold: 0.70,
            status: 'unacceptable',
            clinicalDescription: 'Sub-threshold pupil dilation caused flash vignetting in temporal half.',
          },
          contrast: {
            name: 'Vessel Contrast',
            value: 0.44,
            ...
            threshold: 0.65,
            status: 'unacceptable',
            clinicalDescription: 'Inadequate dynamic range to discriminate microaneurysms.',
          },
          noise: {
            name: 'Signal-to-Noise',
            value: 0.52,
            displayValue: '14.2 dB',
            threshold: 0.65,
            status: 'warning',
            clinicalDescription: 'Elevated sensor gain noise from underexposure compensation.',
          },
        },
